...
<template>
  <div class="uc-content">
    ...
    <UcPageHeader
      title="Intervenants"
      subtitle="Gestion des formateurs et vacataires"
    >
      <template #actions>
        <button
          v-if="canWrite"
    ...
    <UcModal
      v-model="showForm"
      :title="editTarget ? 'Modifier l\'intervenant' : 'Nouvel intervenant'"
      @close="closeForm"
    >
      ...
      <form @submit.prevent="save" class="space-y-4">
        ...
        <div>
          <div class="flex items-center justify-between mb-2">
            <label style="font-size:11px;font-weight:600;color:#333;text-transform:uppercase;letter-spacing:0.3px;">Filières enseignées</label>
