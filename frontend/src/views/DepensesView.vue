...
<template>
  <div class="uc-content">
    ...
    <UcPageHeader
      title="Dépenses"
      subtitle="Journal des dépenses de fonctionnement"
    >
      <template #actions>
    ...
    >
      <form @submit.prevent="saveDepense" style="display:flex;flex-direction:column;gap:14px;">
        ...
        <UcFormGrid :cols="2">
          <UcFormGroup label="Catégorie" :required="true">
        ...
        <UcFormGrid :cols="2">
          <UcFormGroup label="Bénéficiaire / Fournisseur">
            <input v-model="form.beneficiaire" type="text" />
          </UcFormGroup>
          <UcFormGroup label="Réf. facture">
        ...
        <UcFormGroup label="Justificatif">
